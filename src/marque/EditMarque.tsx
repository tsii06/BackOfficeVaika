        ...
        console.log(newData);
            ...
            const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
                ...
                try {
                  ...
                  await axios.put(`https://vaikaback-production.up.railway.app/marque/${id}`, categorie,config);
                  navigate('/listeM');
                } catch (error) {
              ...
              const loadCat= async()=>{
                ...
                const result =  await axios.get(`https://vaikaback-production.up.railway.app/marque/${id}`,config);
   ...
   <div>
        ...
        <div className='container'>
            <div className="row log">
                  <h1 className='text-center fw-normal mb-3 '>Edit marque</h1>
                      ...
                      <div className="col-lg-4 shadow ">
                        ...
                        <div className="input-group mb-3 mt-5">
                              ...
                              <NavLink className="navbar-brand" to="/listeM"><button className='btn btn-outline-danger col-lg-12  mt-3 mb-2 '>Cancel</button></NavLink>
                        </form>
                      </div>
                      <div className="col-lg-4"></div>
            </div>
